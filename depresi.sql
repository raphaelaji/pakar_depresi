...
INSERT INTO `tb_faktor` (`id_faktor`, `faktor`) VALUES
('F001', 'Afektif'),
('F002', 'Kognitif'),
('F003', 'Somatik');
...
CREATE TABLE IF NOT EXISTS `tb_premis1` (
`id_premis1` int(5) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_premis2` (
`id_premis3` int(5) NOT NULL,
  `ket` varchar(20) NOT NULL,
  `bts_bwh` float NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_premis3` (
`id_premis3` int(5) NOT NULL,
  `ket` varchar(20) NOT NULL,
  `bts_bwh` float NOT NULL,
  `bts_ats` float NOT NULL
